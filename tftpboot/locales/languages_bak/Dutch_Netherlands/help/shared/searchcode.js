...
strA.push("    <td><span class='bodycopy'><strong>ZOEKRESULTATEN</strong> <br>");
strA.push("      "+hits+" alle resultaten voor <strong>"+searchText+"</strong></span><br>");
strA.push("      <hr size='1' color='#4A5AAA'>");
     
strA.push("     <span class='bodycopy'><a onClick='top.hide_summaries(document);' href='javascript:void(0)'>Samenvatting verbergen</a>  |  <a onClick='top.show_summaries(document);' href='javascript:void(0)'>Samenvatting weergeven  ");
strA.push("     </a></span>");

//results
  if(hitsIndex.length == 0) {
    strA.push('<p class="bodycopy"><br>');
    strA.push('Geen overeenkomsten</p>');
  }
  else {
	var pth = "";
	var ttl = "";
	...
	for(i=0;i<hitsIndex.length;++i) {
	  ...
	  if(fileLine=="undefined") {
		...
		if (textIndex < fileLine.length)
                ...
                strA.push('<p class="bodycopy"><strong>'+(i+1)+'.</strong> <a href="..'+pth+'"><strong>'+ttl+'</strong></a> <a href="..'+tt+'" target="_blank"><img src="images/open_new_win16.gif" alt="'+ttl+' openen in nieuw venster" width="16" height="11"><a><br>');
                if(sum)
                  strA.push(txtStr);
                strA.push('</p>');
    	  }	
